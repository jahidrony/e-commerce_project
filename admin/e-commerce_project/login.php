            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3" action="" method="POST">
                  ...
                  <div class="mt-3">
                    <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="../../index.php">SIGN IN</button type="submit">
                  </div>
                ...
                <?php
                      if($_POST){
                        ...
                        $result=$mysqli->common_select_single('role_user','*',$_POST);
                        if($result['error']){
                        ...
                        if($result['selectdata']->status==1){
                          $_SESSION['userdata']=$result['selectdata'];
