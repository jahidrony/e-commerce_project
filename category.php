...
<?php
	$where['id']=$_GET['id'];
	$page_details=$mysqli->common_select_single('product_category','*',$where)['selectdata'];

?>
    

    <!-- Breadcrumb Section Begin -->
    <section class="breadcrumb-section set-bg" data-setbg="admin/images/category/<?= $page_details->banner ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2><?= $page_details->category ?></h2>
    ...
    <section class="product spad">
        <div class="container">
            <div class="row">
				...
				<?php
	$discountwhere['category_id']=$_GET['id'];
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="#"><?= $dispro->desc_short ?></a></h5>
